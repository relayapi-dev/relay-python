...
from ....types.inbox.comments.like_create_response import LikeCreateResponse
from ....types.inbox.comments.like_delete_response import LikeDeleteResponse
...
class LikeResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/v1/inbox/comments/{comment_id}/like", comment_id=comment_id),
