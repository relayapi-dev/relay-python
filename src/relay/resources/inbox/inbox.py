...
class InboxResourceWithRawResponse:
    ...
    def comments(self) -> CommentsResourceWithRawResponse:
        return CommentsResourceWithRawResponse(self._inbox.comments)
    ...
    def reviews(self) -> ReviewsResourceWithRawResponse:
        return ReviewsResourceWithRawResponse(self._inbox.reviews)
...
class AsyncInboxResourceWithRawResponse:
    ...
    def comments(self) -> AsyncCommentsResourceWithRawResponse:
        return AsyncCommentsResourceWithRawResponse(self._inbox.comments)
    ...
    def reviews(self) -> AsyncReviewsResourceWithRawResponse:
        return AsyncReviewsResourceWithRawResponse(self._inbox.reviews)
...
class InboxResourceWithStreamingResponse:
    ...
    def comments(self) -> CommentsResourceWithStreamingResponse:
        return CommentsResourceWithStreamingResponse(self._inbox.comments)
    ...
    def reviews(self) -> ReviewsResourceWithStreamingResponse:
        return ReviewsResourceWithStreamingResponse(self._inbox.reviews)
...
class AsyncInboxResourceWithStreamingResponse:
    ...
    def comments(self) -> AsyncCommentsResourceWithStreamingResponse:
        return AsyncCommentsResourceWithStreamingResponse(self._inbox.comments)
    ...
    def reviews(self) -> AsyncReviewsResourceWithStreamingResponse:
        return AsyncReviewsResourceWithStreamingResponse(self._inbox.reviews)
