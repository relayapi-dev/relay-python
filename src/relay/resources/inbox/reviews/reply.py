...
from ....types.inbox.reviews import reply_create_params
from ....types.inbox.reviews.reply_create_response import ReplyCreateResponse
from ....types.inbox.reviews.reply_delete_response import ReplyDeleteResponse
...
class ReplyResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/v1/inbox/reviews/{review_id}/reply", review_id=review_id),
