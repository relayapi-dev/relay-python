...
from ...types.posts import log_list_params
from ..._base_client import make_request_options
from ...types.posts.log_list_response import LogListResponse
from ...types.posts.log_retrieve_response import LogRetrieveResponse
...
class LogsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v1/posts/{id}/logs", id=id),
