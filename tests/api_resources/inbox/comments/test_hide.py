...
class TestHide:
    ...
    def test_method_create(self, client: Relay) -> None:
        ...
        assert_matches_type(HideCreateResponse, hide, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_create(self, client: Relay) -> None:
        response = client.inbox.comments.hide.with_raw_response.create(
            "comment_id",
        )
    ...
    def test_streaming_response_create(self, client: Relay) -> None:
        with client.inbox.comments.hide.with_streaming_response.create(
            "comment_id",
        ) as response:
    ...
    def test_path_params_create(self, client: Relay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `comment_id` but received ''"):
            client.inbox.comments.hide.with_raw_response.create(
                "",
            )
    ...
    def test_method_delete(self, client: Relay) -> None:
        ...
        assert_matches_type(HideDeleteResponse, hide, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_delete(self, client: Relay) -> None:
        response = client.inbox.comments.hide.with_raw_response.delete(
            "comment_id",
        )
    ...
    def test_streaming_response_delete(self, client: Relay) -> None:
        with client.inbox.comments.hide.with_streaming_response.delete(
            "comment_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Relay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `comment_id` but received ''"):
            client.inbox.comments.hide.with_raw_response.delete(
                "",
            )
...
class TestAsyncHide:
    ...
    async def test_method_create(self, async_client: AsyncRelay) -> None:
        hide = await async_client.inbox.comments.hide.create(
            "comment_id",
        )
        assert_matches_type(HideCreateResponse, hide, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncRelay) -> None:
        response = await async_client.inbox.comments.hide.with_raw_response.create(
            "comment_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        hide = await response.parse()
        assert_matches_type(HideCreateResponse, hide, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncRelay) -> None:
        async with async_client.inbox.comments.hide.with_streaming_response.create(
            "comment_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncRelay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `comment_id` but received ''"):
            await async_client.inbox.comments.hide.with_raw_response.create(
                "",
            )
    ...
    async def test_method_delete(self, async_client: AsyncRelay) -> None:
        hide = await async_client.inbox.comments.hide.delete(
            "comment_id",
        )
        assert_matches_type(HideDeleteResponse, hide, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncRelay) -> None:
        response = await async_client.inbox.comments.hide.with_raw_response.delete(
            "comment_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncRelay) -> None:
        async with async_client.inbox.comments.hide.with_streaming_response.delete(
            "comment_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncRelay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `comment_id` but received ''"):
            await async_client.inbox.comments.hide.with_raw_response.delete(
                "",
            )
