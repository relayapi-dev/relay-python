...
from relay.types.posts import LogListResponse, LogRetrieveResponse
...
class TestLogs:
    ...
    def test_raw_response_retrieve(self, client: Relay) -> None:
        response = client.posts.logs.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Relay) -> None:
        with client.posts.logs.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Relay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.posts.logs.with_raw_response.retrieve(
                "",
            )
    ...
    def test_raw_response_list(self, client: Relay) -> None:
        response = client.posts.logs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Relay) -> None:
        with client.posts.logs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncLogs:
    ...
    async def test_method_retrieve(self, async_client: AsyncRelay) -> None:
        log = await async_client.posts.logs.retrieve(
            "id",
        )
        assert_matches_type(LogRetrieveResponse, log, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncRelay) -> None:
        response = await async_client.posts.logs.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncRelay) -> None:
        async with async_client.posts.logs.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncRelay) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.posts.logs.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncRelay) -> None:
        log = await async_client.posts.logs.list()
        assert_matches_type(LogListResponse, log, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncRelay) -> None:
        response = await async_client.posts.logs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncRelay) -> None:
        async with async_client.posts.logs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
